D('zhp.net.pl', noneRegistrar, DnsProvider(cloudflareProvider), DefaultTTL(3600),
    ...
    Delegation_NS('poszukiwaczeprzygod', ['ns1.cba.pl.', 'ns2.cba.pl.']),  // TODO nie działą?
    Delegation_NS('rajdpozazasiegiem', ['ns1.atthost.pl.', 'ns2.atthost.pl.']),  // TODO nie działą?
    ...
    Delegation_A('1szdw', '188.40.77.144'), // MS365-5563   // TODO nie działą?
