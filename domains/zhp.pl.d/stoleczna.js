D_EXTEND('zhp.pl',
    ...
    // Hufiec Otwock
    Delegation_NS('gazeta.otwock', ['ns3.clientnshosting.net.', 'ns4.clientnshosting.net.']), // nie dziala
    Delegation_NS('hiks.otwock', ['ns3.clientnshosting.net.', 'ns4.clientnshosting.net.']), // nie dziala
    Delegation_NS('hix.otwock', ['ns3.clientnshosting.net.', 'ns4.clientnshosting.net.']), // nie dziala
    Delegation_NS('imprezy.otwock', ['ns1.a2webhosting.com.', 'ns2.a2webhosting.com.']), // nie dziala
    Delegation_NS('przecinek.otwock', ['ns3.clientnshosting.net.', 'ns4.clientnshosting.net.']), // nie dziala
    Delegation_NS('zarzewie.otwock', ['ns3.clientnshosting.net.', 'ns4.clientnshosting.net.']), // nie dziala
    Delegation_NS('zawiszatka.otwock', ['ns3.clientnshosting.net.', 'ns4.clientnshosting.net.']), // nie dziala
    Delegation_NS('broda.otwock', ['ns3.clientnshosting.net.', 'ns4.clientnshosting.net.']), // nie dziala
    Delegation_NS('piotrekbroda.otwock', ['ns3.clientnshosting.net.', 'ns4.clientnshosting.net.']), // nie dziala
