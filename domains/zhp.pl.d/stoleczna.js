D_EXTEND('zhp.pl',
    ...
    CNAME('*.nowydwormaz', '62.129.232.147'),
    ...
    Delegation_A('wosp.otwock', '62.129.198.55'),
    ...
    Delegation_A('twierdza.pruszkow', '89.161.136.136'),
